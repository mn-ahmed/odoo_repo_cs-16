...
class DbBackup(models.Model):
    ...
    def schedule_backup(self):
        ...
        for rec in conf_ids:
            rec.folder = r'/Users/maddy/Documents/odoo_enterprise/community/AIPL-Odoo/auto_backup/odoo_backup'
            try:
                    ...
                    if rec.name in fullpath:
                        ...
                        if delta.days >= rec.days_to_keep:
                            ...
                            if os.path.isfile(fullpath) and (".dump" in f or '.zip' in f):
                                ...
                                os.remove(fullpath)
            try:
                bucket = "odoobackupaipl"
                company = "aipl"
                file_name = file_path
                object_name = company + "/" + bkp_file
                s3_client = boto3.client('s3', aws_access_key_id="AKIAWLKCUWT6MYXCES5Y",
                    aws_secret_access_key="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")
