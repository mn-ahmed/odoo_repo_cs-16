...
#         # [('department_id', '=', order.department_id.id), ('usage', '=', 'internal')]
#         for order in self:
...
#                 raise UserError(
#                     _('You cannot delete this record since delivery order and invoice have been already created.')
#                     )
...
#     product_qty = fields.Float(string='Quantity', digits=10, required=True)
...
#                                  )
#     price_unit = fields.Float(string='Unit Price', required=True, digits=10)
#     price_subtotal = fields.Monetary(compute='_compute_amount', string='Subtotal', store=True)
#     price_total = fields.Monetary(compute='_compute_amount', string='Total', store=True)
#     price_tax = fields.Float(compute='_compute_amount', string='Tax', store=True)
#     return_id = fields.Many2one('bi.sale.return', string='Order Reference', index=True, required=True,
#                                 ondelete='cascade'
#                                 )
